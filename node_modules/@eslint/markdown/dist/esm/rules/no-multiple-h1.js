            ...
            html(node) {
                ...
                while ((match = h1TagPattern.exec(node.value)) !== null) {
                    ...
                    if (h1Count > 1) {
                        ...
                        const { lineOffset: endLineOffset, columnOffset: endColumnOffset, } = findOffsets(node.value, match.index + match[0].length);
                        ...
                        const startColumn = (startLine === nodeStartLine
                            ? nodeStartColumn
                            : 1) + startColumnOffset;
                        const endColumn = (endLine === nodeStartLine ? nodeStartColumn : 1) +
                            endColumnOffset;
                        context.report({
                            loc: {
                                start: {
