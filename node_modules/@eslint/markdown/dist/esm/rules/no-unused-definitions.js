...
export default {
    meta: {
        ...
        messages: {
            unusedDefinition: "Unexpected unused definition `{{ identifier }}` found.",
            unusedFootnoteDefinition: "Unexpected unused footnote definition `{{ identifier }}` found.",
        },
        schema: [
            {
                type: "object",
    ...
    create(context) {
        ...
        const allowFootnoteDefinitions = new Set(context.options[0]?.allowFootnoteDefinitions);
